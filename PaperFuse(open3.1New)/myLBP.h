	...
	public:     // public attribute
		...
		*/
		...
		public:
			...
			/// 24 points with radius 3.
			static const int LBP_24_3 = LBP | (0x03 << PATTERN_OFFSET);
			...
			/// 24 points with radius 3 and uniform pattern.
			static const int LBP_24_3_UNIFORM = LBP_24_3 | UNIFORM_FLAG;
		};

		/// Number of patterns, not include uniform pattern
		static const unsigned int NUMBER_OF_PATTERNS = 4;
		...
		*/
		...
		static const unsigned int MAX_LENGTH = 24;
